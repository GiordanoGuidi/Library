    ...
    public class DataSeeder
    {
        ...
        public void Seed()
        {
            ...
            if (!_context.Authors.Any())
            {
                ...
                _context.SaveChanges();  // Salva subito dopo aver aggiunto gli autori
            }
            ...
            if (!_context.Addresses.Any())
            {
                ...
                _context.SaveChanges();  // Salva subito dopo aver aggiunto gli indirizzi
            }

            // Carica gli autori e gli indirizzi da DbContext
            var authorsList = _context.Authors.AsNoTracking().ToList();  // Disabilita il tracking
            var addressesList = _context.Addresses.AsNoTracking().ToList();  // Disabilita il tracking
            ...
            if (!_context.Books.Any())
            {
                ...
                .RuleFor(b => b.AuthorId, f => f.PickRandom(authorsList.Select(a => a.Id).ToList()))  // Utilizza solo gli Id
                ...
                _context.SaveChanges();  // Salva subito dopo aver aggiunto i libri
            }
            ...
            if (!_context.Users.Any())
            {
                ...
                _context.SaveChanges();  // Salva subito dopo aver aggiunto gli utenti
            }
        }
    }
    }
